...
public final class CaptureActivity extends AppCompatActivity implements
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.activity_capture_custome);
		...
		tvHelper.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				//弹出帮助Dialog
				HelpeDialog helpeDialog = new HelpeDialog(CaptureActivity.this);
				helpeDialog.show();
			}
		});
		hasSurface = false;
		...
		ImageView btnManual = (ImageView) findViewById(R.id.btn_manual);
		btnManual.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				//启动手动输入
				startActivityForResult(new Intent(CaptureActivity.this, ManualInputSerialActivity.class), REQUEST_SERRIAL_NUMBER);
			}
		});
			...
			public void onClick(View v) {
				if (cameraManager != null) {
					...
					if (Config.KEY_FRONT_LIGHT == true) {
						opreateView
								.setImageResource(R.mipmap.scan_qrcode_flash_light_on);
						tvFlash.setText("关闭手电筒");
					} else {
						opreateView
								.setImageResource(R.mipmap.scan_qrcode_flash_light_off);
						tvFlash.setText("打开手电筒");
					}
