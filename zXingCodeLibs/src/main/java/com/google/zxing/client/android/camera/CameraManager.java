...
import com.libs.zxing.DpPxUtil;
...
//    private static final int MAX_FRAME_HEIGHT = 700;
     ...
     * to clear the handler so it will only receive one message.
     */
    ...
    public CameraManager(Context context) {
        ...
        MIN_FRAME_WIDTH = (int) DpPxUtil.getPix(context, 180);
        MIN_FRAME_HEIGHT = (int) DpPxUtil.getPix(context, 180);
        MAX_FRAME_WIDTH = (int) DpPxUtil.getPix(context,240);
        MAX_FRAME_HEIGHT = (int) DpPxUtil.getPix(context,240);
     ...
     * byte[] in the message.obj field, with width and height encoded as message.arg1 and message
     * .arg2,
     * respectively.
     *
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.y - height) / 3;//修改扫描框距离上边界的距离
     ...
     * determine them automatically based on screen resolution.
     *
     ...
     * the preview buffers, as described by Camera.Parameters.
     *
